import Flask, render_template, url_for, request, redirect
...
def index():
    if request.method == 'POST':
        ...
        if prediction != None:
            return render_template('result_1.html', result = prediction, review = input_review, description= description, sentiment= sentiment)
